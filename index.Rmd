...
Opinions_plot <- Opinions |> ggplot(aes(x = prop, y= Opinions_on_SD, fill = PARTY_affiliation)) + geom_col(position = "dodge") + labs( x= "Proportions", y = "Opinions on operational status of places of worship", title = "Opinions according to Party affiliation")
Opinions_plot
```
